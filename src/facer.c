...
static struct quirk_entry quirk_acer_predator_g5_793 = {
                .turbo = 1,
                .cpu_fans = 1,
                .gpu_fans = 1,
};
...
static const struct dmi_system_id acer_quirks[] __initconst = {
		...
		},
		{
                ...
                {
                                .callback = dmi_matched,
                                .ident = "Acer Predator G5-793",
                                .matches = {
                                                DMI_MATCH(DMI_SYS_VENDOR, "Acer"),
                                                DMI_MATCH(DMI_PRODUCT_NAME, "Predator G5-793"),
                                },
                                .driver_data = &quirk_acer_predator_g5_793,
                },
